  ...
  return (
    <div>
      ...
      <p className="text-sm text-stone-500 mb-4">
        포털에 가입하지 않은 거래처용입니다. 거래처명과 품목·가격을 직접 입력하거나, 아래에서 로스팅 수기 입력분을 체크해서 바로 가져올 수 있습니다. 저장되지 않고, 그 자리에서 PDF/공유만 됩니다.
      </p>
      <QuickStatementForm manualEntries={manualEntries} />
    </div>
  );
}
